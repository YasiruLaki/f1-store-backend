...
exports.handler = async (event) => {
    ...
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            success_url: `https://pitlaneperformances.com/order-success?session_id={CHECKOUT_SESSION_ID}&orderID=${encodedOrderID}`, // Replace with your success URL
            cancel_url: 'https://pitlaneperformances.com/cart',
        });
